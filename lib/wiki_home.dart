...
class _WikiHomeState extends State<WikiHome> {
  ...
  Widget build(BuildContext context) {
    return Consumer<WikiProvider>(
      builder: (context, wikiNotifier, child) => Scaffold(
        appBar: AppBar(
                        ...
                        onSelected: (item) {
                          switch (item) {
                            case 0:
                              ...
                              controller.data!.loadUrl(widget.url + 'Olayama');
                              setState(() {
                            ...
                            case 1:
                              ...
                              widget.url = 'https://nia.m.wikipedia.org/wiki/';
                              controller.data!.loadUrl(widget.url + 'Olayama');
                              setState(() {
                            ...
                            case 2:
                              ...
                              widget.url = 'https://nia.m.wiktionary.org/wiki/';
                              controller.data!.loadUrl(widget.url + 'Olayama');
                              setState(() {
